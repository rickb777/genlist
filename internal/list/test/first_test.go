...
//	}
//
//	f1, err1 := things.Find(func(x Thing) bool {
//		return x.Name == "Third"
//	})
//
//	if err1 != nil {
...
//	}
//
//	_, err2 := things.Find(func(x Thing) bool {
//		return x.Name == "Dummy"
//	})
//
//	if err2 == nil {
...
//	}
//
//	_, err3 := ThingList{}.Find(func(x Thing) bool {
//		return true
//	})
//
//	if err3 == nil {
//		t.Errorf("First should fail on empty list")
//	}
}
