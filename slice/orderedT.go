...
var orderedT = &typewriter.Template{
	Name: "Ordered",
	Text: `
// Min{{.TypeParameter.LongName}} selects the least value of {{.TypeParameter}} in {{.SliceName}}.
// Returns error on {{.SliceName}} with no elements. See: http://clipperhouse.github.io/gen/#MinCustom
...
// Max{{.TypeParameter.LongName}} selects the largest value of {{.TypeParameter}} in {{.SliceName}}.
// Returns error on {{.SliceName}} with no elements. See: http://clipperhouse.github.io/gen/#MaxCustom
